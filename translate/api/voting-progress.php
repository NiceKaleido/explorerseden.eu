...
$cacheFile = $cacheDir . '/translate-voting-progress.json';
$cacheTtl = 60;
...
try {
  ...
  $rows = $pdo->query('
    ...
    LEFT JOIN translation_suggestions ts
      ON ts.translation_key_id = tk.id AND ts.locale_code = l.code AND ts.status = \'pending\'
